...
export function YearProgress({ targetDate }: { targetDate: Date }) {
  ...
  useEffect(() => {
    const calculateYearProgress = () => {
      ...
      const totalMilliseconds = targetDate.getTime() - startOfYear.getTime();
  ...
  return (
    <div className="bg-[#c0c0c0] border-2 border-[#ffffff] border-r-[#808080] border-b-[#808080] mb-2 w-64 mx-auto shadow-md relative">
      ...
      <div className="px-2 pb-2">
        <div className="text-center mb-1 text-black font-sans text-[0.8rem]">{remainingDays} días restantes para el {endOfYear.toLocaleDateString('es-ES', {day: 'numeric', month: 'numeric', year: 'numeric'})}</div>
